...
def run(epoch, loader, partition):
    ...
    for i, data in enumerate(loader):
        ...
        if args.use_tar_labels:
            ...
            loss_MMD = MMD_scale*args.MMD_coef*mmd(mmd_in[0], mmd_in[1]) 
...
if __name__ == "__main__":
    ...
    if args.model=='LorentzNet':
        ...
        if args.model=='ParticleNet':
            ...
            kwargs={'fc_params': [(128, 0), (16, 0), (128, args.dropout)], 'conv_params': [(7, (32, 32, 32)),(7, (64, 64, 64))]}
